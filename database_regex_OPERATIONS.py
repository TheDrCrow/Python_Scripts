...
c.execute(
    "SELECT uid, sex, referrer, in_patient, procedure_code, PRIMARY_CONCLUSION , INFORMATION_EFF_SCORE FROM nimreports WHERE procedure_code REGEXP ?" , [r'\bM.{3,4}'])  
